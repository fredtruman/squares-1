...
(function($) {
            ...
            success: function(json) {
                ...
                $.ajax({
                    ...
                    success: function(data){
                        console.log('learn/choose data: ', data);
                        $.each(data, function() {
                        ...
                        console.log('json.response.groups[0].items ', json.response.groups[0].items)
    ...
    function addPixels() {
        ...
        $.getJSON(home+'learn/getvisdata/'+ userId, function(VisData){
